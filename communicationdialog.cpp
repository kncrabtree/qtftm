     ...
     ui(new Ui::CommunicationDialog)
{
	...
	connect(ui->gpibDeviceComboBox,cmbVc,this,&CommunicationDialog::gpibDeviceChanged);
	connect(ui->tcpDeviceComboBox,cmbVc,this,&CommunicationDialog::tcpDeviceChanged);
	connect(ui->rs232DeviceComboBox,cmbVc,this,&CommunicationDialog::rs232DeviceChanged);

	connect(ui->gpibTestButton,&QAbstractButton::clicked,this,&CommunicationDialog::testGpib);
	connect(ui->tcpTestButton,&QAbstractButton::clicked,this,&CommunicationDialog::testTcp);
	connect(ui->rs232TestButton,&QAbstractButton::clicked,this,&CommunicationDialog::testRs232);
}
